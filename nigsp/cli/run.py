...
def _get_parser():
    ...
    required.add_argument('-f', '--input-func',
                          ...
                          help=('Complete path (absolute or relative) and name '
                                ...
                                'be specified.'),
                          required=True)
    required.add_argument('-s', '--input-structural',
                          dest='scname',
                          type=str,
                          help=('Complete path (absolute or relative) and name '
    ...
    opt_proc.add_argument('-a', '--input-atlas',
                          dest='atlasname',
                          type=str,
                          help=('Complete path (absolute or relative) and name '
                          ...
                          default=None)
    opt_proc.add_argument('-idx', '--split-index',
                          dest='index',
                          type=str,
                          help=('The index of the harmonic that should split the '
    ...
    opt_out.add_argument('-odir', '--output-directory',
                         dest='outdir',
                         type=str,
                         help=('Complete path (absolute or relative) and name '
                               ...
                               'functional file.'),
                         default=None)
    opt_out.add_argument('-ofile', '--output-file',
                         dest='outname',
                         type=str,
                         help=('Name of, and if desired path to, the output files.'
    ...
    opt_surr_type.add_argument('-sci', '--informed-surrogates',
                               ...
                               action='store_const',
                               const='informed',
                               help=('Create surrogates informed of the structural '
    ...
    opt_surr_type.add_argument('-scu', '--uninformed-surrogates',
                               ...
                               action='store_const',
                               const='uninformed',
                               help=('Create surrogates ignoring the structural '
                                     'connectivity matrix. Unless this option or '
    ...
    opt_stat.add_argument('-method', '--statistical-method',
                          dest='method',
                          type=str,
                          help=('Type of statistical test to adopt. Possible '
